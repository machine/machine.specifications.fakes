...
namespace Machine.Fakes.Adapters.Specs.FakeItEasy
{
    ...
    public class When_an__out__parameter_is_configured : WithCurrentEngine<FakeItEasyEngine>
    {
    ...
    [Subject(typeof(FakeItEasyEngine))]
    public class When_an__out__parameter_is_configured_with_null : WithCurrentEngine<FakeItEasyEngine>
    {
        static ILookupService _fake;
        static string initial;
    ...
    [Subject(typeof(FakeItEasyEngine))]
    public class When_a__ref__parameter_is_configured : WithCurrentEngine<FakeItEasyEngine>
    {
    ...
    [Subject(typeof(FakeItEasyEngine))]
    public class When_an__out__and_a__ref__parameter_are_configured : WithCurrentEngine<FakeItEasyEngine>
    {
    ...
    [Subject(typeof(FakeItEasyEngine))]
    public class When_more_out_and_ref_parameters_are_configured_than_the_method_has : WithCurrentEngine<FakeItEasyEngine>
    {
        static IReturnOutAndRef _fake;
        static string initial1;
        static object initial2;
    ...
    [Subject(typeof(FakeItEasyEngine))]
    public class When_less_out_and_ref_parameters_are_configured_than_the_method_has : WithCurrentEngine<FakeItEasyEngine>
    {
        static IReturnOutAndRef _fake;
        static string initial1;
        static object initial2;
