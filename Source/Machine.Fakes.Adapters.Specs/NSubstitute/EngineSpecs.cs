...
namespace Machine.Fakes.Adapters.Specs.NSubstitute
{
    ...
    [Subject(typeof(NSubstituteEngine))]
    [Tags("Verifying a mock (without inline constraints)", "NSubstitute")]
    ...
    [Subject(typeof(NSubstituteEngine))]
    [Tags("NSubstitute", "Constructing an instance")]
    public class When_using_a_abstract_base_classes_as_a_fakes_and_the_constructor_parameter_is_unfakable : WithCurrentEngine<NSubstituteEngine>
    {
