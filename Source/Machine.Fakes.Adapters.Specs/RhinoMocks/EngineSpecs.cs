...
namespace Machine.Fakes.Adapters.Specs.RhinoMocks
{
    ...
    [Subject(typeof(RhinoFakeEngine))]
    [Tags("Rhinomocks", "Constructing an instance")]
    ...
    [Subject(typeof(RhinoFakeEngine))]
    [Tags("Rhinomocks", "Constructing an instance")]
    public class When_using_a_abstract_base_classes_as_a_fakes_and_the_constructor_parameter_is_unfakable : WithCurrentEngine<RhinoFakeEngine>
    {
