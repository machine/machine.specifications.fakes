...
namespace Machine.Fakes.Adapters.Specs.Moq
{
    ...
    [Subject(typeof(MoqFakeEngine))]
    [Tags("Verifying a mock (without inline constraints)", "Moq")]
    ...
    [Subject(typeof(MoqFakeEngine))]
    [Tags("Moq", "Constructing an instance")]
    public class When_using_a_abstract_base_classes_as_a_fakes_and_the_constructor_parameter_is_unfakable : WithCurrentEngine<MoqFakeEngine>
    {
